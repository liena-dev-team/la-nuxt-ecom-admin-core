			...
			<v-row>
					...
					<v-card>
						...
						<v-card-text>
							<advanced-tree ref="advanced_tree" :filter_url="FILTER_URL" key_title="name"
								:activatable="true"
								@node:activated="onSelectCategory">
							</advanced-tree>
						</v-card-text>
						<v-divider></v-divider>
						<v-card-actions>
				...
				<v-col cols="12" md="9" class="pa-2">
					<page-card v-show="last_selected_id" ref="category_card" :go_back="false"
						page_class="App\AdminPage\Blog\CategoryCard" :caption_fields="['name']"
						@field:changed="onFieldUpdated" @record:created="onCardUpdated"
						@record:deleted="onCardDeleted"
...
// Constants
const FILTER_URL = "/admin/blog/category/filter";
